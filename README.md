...
## Project Overview  
**ShikShak** is a lightweight, multilingual AI-powered educational platform that generates curriculum-aligned content in 22+ Indian languages. Designed for **100% offline operation** with **zero reliance on cloud services**, ShikShak runs efficiently on low-resource devices (4-8GB RAM) without requiring internet connectivity.
...
**Note:** ShikShak is **100% offline** and requires **no external API keys** or cloud services. All AI processing happens locally using Ollama and local models.
